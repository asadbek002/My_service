...
type Customer={id:string;firstName:string;lastName?:string;phone:string;notes?:string;telegramChatId?:string;devices:{id:string;brand:string;model:string;imei?:string}[];orders:Order[]};
